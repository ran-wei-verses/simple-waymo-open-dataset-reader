"Based on https://github.com/sisl/SceneInformer"
...
from simple_waymo_open_dataset_reader import map_pb2, scenario_pb2
...
def waymo_to_scenario(protobuf: scenario_pb2.Scenario, include_roads = True) -> None:
